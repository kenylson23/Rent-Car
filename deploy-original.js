...
try {
  console.log('Fazendo deploy do design original React...');
  
  // Ensure dist directory exists
  fs.mkdirSync('dist', { recursive: true });

  // Read the original CSS styles
  const originalCSS = fs.readFileSync('client/src/index.css', 'utf8');

  // Create complete HTML with original React component structure
...
<head>
  ...
  <style>
    ${originalCSS.replace('@tailwind base;', '').replace('@tailwind components;', '').replace('@tailwind utilities;', '')}
...
<body>
  <!-- Navigation - Exact copy from Navigation component -->
  ...
  <div class="min-h-screen overflow-x-hidden">
    <!-- Hero Section - Exact copy from HeroSection component -->
    ...
    <!-- Services Section - Exact copy from ServicesSection component -->
    ...
    <!-- Fleet Section - Exact copy from FleetSection component -->
    ...
    <!-- Testimonials Section - Exact copy from TestimonialsSection component -->
    ...
    <!-- Contact Section - Exact copy from ContactSection component -->
    <section id="contact" class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-4xl mx-auto">
          <form class="bg-gray-50 rounded-2xl p-8 shadow-lg" onsubmit="submitForm(); return false;">
    ...
    <!-- Footer - Exact copy from Footer component -->
    ...
    <!-- WhatsApp Float Button - Exact copy from Home component -->
    <a 
  ...
  <script>
    ...
    // Form submission function for WhatsApp integration - Exact copy from ContactSection component
    function submitForm() {
