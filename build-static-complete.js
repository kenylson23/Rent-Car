...
try {
  console.log('Construindo versão estática completa baseada no design original...');
  
  // Ensure dist directory exists
  fs.mkdirSync('dist', { recursive: true });
  fs.mkdirSync('dist/assets', { recursive: true });

  // Create complete HTML with exact original styling
...
<body>
  ...
  <section id="home" class="hero-bg min-h-screen flex items-center relative">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
      <div class="text-center">
        ...
        <p class="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed animate-fadeInUp animate-delay-200">
  ...
  <a href="https://wa.me/244949639932" target="_blank" 
...
Aguardo confirmação da disponibilidade e valores. Obrigado!\`;
  ...
  console.log('Build estático completo finalizado!');
